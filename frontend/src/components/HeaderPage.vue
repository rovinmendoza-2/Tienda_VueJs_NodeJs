                ...
                <div class="row d-flex align-items-center">
                    <div class="col-sm-7 d-none d-sm-block">
                        <ul class="list-inline topbar-text mb-0">
                            ...
                            <li class="list-inline-item px-3 border-start d-none d-lg-inline-block">Envios gratis desde $300
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated megamenu py-lg-0">
                                <div class="row">
                                        ...
                                        <div class="row p-3 pe-lg-0 ps-lg-5 pt-lg-5">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <ul class="megamenu-list list-unstyled">
                                                    ...
                                                    <li class="megamenu-list-item"><a class="megamenu-list-link"
                                                            href="docs/docs-directory-structure.html">Directory structure
                                                        </a></li>
                                                    <li class="megamenu-list-item"><a class="megamenu-list-link"
                                    ...
                                    <div class="col-lg-3 d-none d-lg-block position-relative"><img class="bg-image"
                                            src="https://d19m59y37dris4.cloudfront.net/sell/2-0/img/megamenu.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </li>
